...
def test_arc_sketch_to_arc():
    response = client.post(
        "/aff/arc/sketch-to-arc",
        json={
            "post": {
                "mirror": False,
                "straighten_x": False,
            ...
            "params": {
                ...
                "stop": 0,
                "start": 0,
                "image": "data:image/png;base64,",
            },
        },
    )
    assert response.status_code == 200
    assert response.json() == {
        "code": 0,
        "result": "arc(0,0,0.71,0.77,s,0.75,0.66,0,none,true);\narc(0,0,0.77,0.77,s,0.66,0.55,0,none,true);\narc(0,0,0.77,0.51,s,0.55,0.21,0,none,true);\narc(0,0,0.51,0.28,s,0.21,0.47,0,none,true);\narc(0,0,0.28,0.26,s,0.47,0.55,0,none,true);\narc(0,0,0.26,0.27,s,0.55,0.65,0,none,true);\narc(0,0,0.27,0.34,s,0.65,0.73,0,none,true);\narc(0,0,0.34,0.48,s,0.73,0.69,0,none,true);\narc(0,0,0.48,0.58,s,0.69,0.75,0,none,true);\narc(0,0,0.58,0.71,s,0.75,0.75,0,none,true);\narc(0,0,0.71,0.58,s,0.75,0.75,0,none,true);\narc(0,0,0.58,0.48,s,0.75,0.69,0,none,true);\narc(0,0,0.48,0.34,s,0.69,0.73,0,none,true);\narc(0,0,0.34,0.27,s,0.73,0.65,0,none,true);\narc(0,0,0.27,0.28,s,0.65,0.47,0,none,true);\narc(0,0,0.28,0.51,s,0.47,0.21,0,none,true);\narc(0,0,0.51,0.47,s,0.21,0.14,0,none,true);\narc(0,0,0.47,0.77,s,0.14,0.55,0,none,true);\narc(0,0,0.77,0.77,s,0.55,0.66,0,none,true);\narc(0,0,0.77,0.71,s,0.66,0.75,0,none,true);\n",
    }

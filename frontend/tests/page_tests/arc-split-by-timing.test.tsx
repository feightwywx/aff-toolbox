...
import ToolPage from "@/pages/tools/arc-split-by-timing";
...
describe("form test", () => {
  ...
  beforeEach(() => {
    ...
    formControl = {
      ...
      timings: screen.getAllByRole("textbox", { name: "input.timings" })[0],
  ...
  it("required", async () => {
    ...
    await user.type(formControl.timings, "timing(500,200.00,4.00);");
